...
### p5.ArrayEval
*methods*
* **eval(evalstr, l1)**, **eval1d(evalstr, l1)**: evaluate a *evalstr* into a one-dimensional Array. An Array of *evalstr* will fill each element in the Array with more than one value. *l1* is the length of the Array to return. The keywords *u*, *su*, *cu*, and *du* will be expanded to a normal map, a signed normal map, a cell position (0 to *l1*-1), and the length of the array (*l1*).
* **eval2d(evalstr, l1, l2)**: evaluate a *evalstr* into a two-dimensional Array. An Array of *evalstr* will fill each element in the Array with more than one value. *l1* and *l2*) are the width and height of the Array to return. The keywords *u/v*, *su/sv*, *cu/sv*, and *du/dv* will be expanded to a normal map, a signed normal map, a cell position (0 to *l1/l2*-1), and the length of the array (*l1/l2*) on the two axes.
* **eval3d(evalstr, l1, l2, l3)**: evaluate a *evalstr* into a three-dimensional Array. An Array of *evalstr* will fill each element in the Array with more than one value. *l1*, *l2*, and *l3*) are the width, height, and depth of the Array to return. The keywords *u/v/w*, *su/sv/sw*, *cu/sv/sw*, and *du/dv/sw* will be expanded to a normal map, a signed normal map, a cell position (0 to *l1/l2/l3*-1), and the length of the array (*l1/l2/l3*) on the two axes.
