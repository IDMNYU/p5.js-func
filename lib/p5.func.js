...
// Golan's Pattern Master Functions:
  ...
  // =============================================================================
    ...
    p5.ArrayEval.prototype.eval = function(_evalstr, _l1) {
      ...
      var _dest = this.createArray(_l1);
      // string expansion:
      // u unwraps to 0-1
   ...
   */
   p5.FastFourierTransform = function(_bufsize, _fs) {
     ...
     // output index. Some DSP's have a special addressing mode that does this
   ...
   p5.FastFourierTransform.prototype.calculateSpectrum = function() {
    ...
    p5.FastFourierTransform.prototype.forward = function(buffer) {
     ...
     if (this.bufferSize !== buffer.length)  { throw "buffer is not the same size as defined FFT. FFT Size: " + bufferSize + " buffer size: " + buffer.length; }
