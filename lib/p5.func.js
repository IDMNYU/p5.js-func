...
(function (root, factory) {
  ...
  // =============================================================================
    ...
    p5.Gen.prototype.harmonics = function(_x, _args) {
      ...
      if(!Array.isArray(_x) && _x.constructor !== var32Array && _x.constructor !== var64Array) {
      ...
      else if(_x.constructor === var32Array) _sum = new var32Array(_x.length);
      else if(_x.constructor === var64Array) _sum = new var64Array(_x.length);
      for(var i in _x) {
        var j = _args.length;
        _sum[i] = 0.0;
        while (j--) {
    ...
    p5.Gen.prototype.bpf = function(_x, _args) {
      ...
      else if(_x.constructor === var32Array) _y = new var32Array(_x.length);
      else if(_x.constructor === var64Array) _y = new var64Array(_x.length);
      for(i in _x)
      {
    ...
    p5.Gen.prototype.random = function() {
      ...
      */
      ...
      if(typeof(arguments[0])!='string') {
        if(!Array.isArray(arguments[0]) && arguments[0].constructor !== var32Array && arguments[0].constructor !== var64Array) {
      ...
      else if(_x.constructor === var32Array) _v = new var32Array(_x.length);
      else if(_x.constructor === var64Array) _v = new var64Array(_x.length);
    ...
    p5.Gen.prototype.listAlgos = function() {
      ...
      for(var i in this.__proto__) {
        ...
        else if(i=="fillvar32Array") _t=false;
        else if(i=="fillvar64Array") _t=false;
    ...
    // array xfer (for pre-rendered use)
    p5.Gen.prototype.fillvar32Array = function(_algo, _len, _args, _seed) {
      var _p = new var32Array(_len);
      var _dest = new var32Array(_len);
    ...
    // array xfer (for pre-rendered use)
    p5.Gen.prototype.fillvar64Array = function(_algo, _len, _args, _seed) {
      var _p = new var64Array(_len);
      var _dest = new var64Array(_len);
...
// Golan's Pattern Master Functions:
  ...
  p5.Ease.prototype.fastSquareRoot = function(_x)
  {
    ...
    var var32 = new var32Array(int8.buffer, 0, 1);
  ...
  // array xfer (for pre-rendered use)
  p5.Ease.prototype.fillvar32Array = function(_algo, _len) {
    var _dest = new var32Array(_len);
    for(var i = 0;i<_len;i++)
    {
      var _p = i/(_len-1); // 0.-1.
  ...
  // array xfer (for pre-rendered use)
  p5.Ease.prototype.fillvar64Array = function(_algo, _len) {
    var _dest = new var64Array(_len);
    for(var i = 0;i<_len;i++)
    {
      var _p = i/(_len-1); // 0.-1.
