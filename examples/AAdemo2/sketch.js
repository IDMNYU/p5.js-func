...
a_algo = styles[floor(random(styles.length))];
b_algo = styles[floor(random(styles.length))];
c_algo = styles[floor(random(styles.length))];
d_algo = styles[floor(random(styles.length))];
e_algo = styles[floor(random(styles.length))];
f_algo = styles[floor(random(styles.length))];
